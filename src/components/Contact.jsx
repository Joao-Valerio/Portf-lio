...
const contactItems = [
  {
    label: 'WhatsApp',
    value: '(44) 98832-2267',
    href: 'https://wa.me/5544988322267',
    description: 'Disponível para conversa rápida',
    icon: (
  ...
  {
    label: 'Email',
    value: 'joaovalerio2359@gmail.com',
  ...
  {
    label: 'LinkedIn',
    value: 'linkedin.com/in/joão-valério',
        ...
        <div className="contact-wrapper">
          <div className="contact-left fade-in">
            ...
            <p className="section-description">
              Estou aberto a oportunidades, freelas e projetos desafiadores.
            ...
            {contactItems.map((item) => (
              ...
              >
                ...
                <div className="contact-item-info">
                  ...
                  <span className="contact-item-desc">{item.description}</span>
                </div>
                <svg
